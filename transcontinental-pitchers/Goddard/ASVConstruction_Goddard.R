...
if (primer == "16S") {
  saveRDS(dadaF, paste0(wd, "/dadaF_EG_16S.rds"))
  saveRDS(dadaR, paste0(wd, "/dadaR_EG_16S.rds"))
} else if (primer == "18S") {
  saveRDS(dadaF, paste0(wd, "/dadaF_EG_18S.rds"))
  saveRDS(dadaR, paste0(wd, "/dadaR_EG_18S.rds"))
}
...
if (primer == "16S") {
  saveRDS(contigs, paste0(wd, "/contigs_EG_16S.rds"))
} else if (primer == "18S") {
  saveRDS(contigs, paste0(wd, "/contigs_EG_18S.rds"))
}
...
if (primer == "16S") {
  saveRDS(seqtab.nochim, paste0(wd, "/seqtab.nochim_EG_16S.rds"))
} else if (primer == "18S") {
  saveRDS(seqtab.nochim, paste0(wd, "/seqtab.nochim_EG_18S.rds"))
}
...
if (primer == "16S") {
  saveRDS(taxa, paste0(wd, "/taxa_EG_16S.rds"))
} else if (primer == "18S") {
  saveRDS(taxa, paste0(wd, "/taxa_EG_18S.rds"))
}
...
if (primer == "16S") {
  saveRDS(taxa.id, paste0(wd, "/taxa.id_EG_16S.rds"))
} else if (primer == "18S") {
  saveRDS(taxa.id, paste0(wd, "/taxa.id_EG_18S.rds"))
}
